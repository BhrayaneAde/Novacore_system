...
import { CalendarCheck, Clock, TrendingUp, Plus } from "lucide-react";
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button icon={Plus} onClick={() => navigate("/app/attendance/requests/new")}>
            Nouvelle demande
          </Button>
        </div>
            ...
            <Card key={index}>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {stat.trend && <p className="text-xs text-green-600 font-medium mt-1">{stat.trend}</p>}
                </div>
              </div>
            </Card>
          ))}
