#!/usr/bin/env python3
"""Seeder force simple sans emojis"""
...
def clear_and_seed():
    ...
    try:
        ...
        # 2. CREER 2 ENTREPRISES
        print("[COMPANY] Creation des entreprises...")
        ...
        # 3. CREER UTILISATEURS (roles differents)
        ...
        # 4. CREER DEPARTEMENTS
        print("[DEPT] Creation des departements...")
        departments = [
            # TechCorp
        ...
        # 5. CREER EMPLOYES
        print("[EMP] Creation des employes...")
        employees = [
            # TechCorp
        ...
        print("[LINK] Liaison users-employees...")
        ...
        # 7. CREER TACHES
        print("[TASK] Creation des taches...")
        tasks = [
            models.Task(title="Rapport mensuel RH", description="Compiler les donnees", assigned_to_id=employees[0].id, assigned_by_id=users[0].id, priority="urgent", status="in_progress", due_date=datetime(2025,1,25)),
        ...
        # 8. CREER CONGES
        print("[LEAVE] Creation des conges...")
        leaves = [
        ...
        # 9. CREER NOTIFICATIONS
        print("[NOTIF] Creation des notifications...")
        notifications = [
            models.Notification(title="Nouvelle demande de conge", message="Sophie a demande des conges", type="info", user_id=users[0].id, created_by_id=users[1].id),
            models.Notification(title="Tache assignee", message="Nouvelle tache de design", type="info", user_id=users[2].id, created_by_id=users[0].id),
        ]
        
        db.add_all(notifications)
        db.commit()
        
        print("[OK] SEEDING COMPLET TERMINE !")
        print("   - 2 entreprises")
        print("   - 8 utilisateurs (roles varies)")
        print("   - 5 departements") 
        print("   - 6 employes")
        print("   - 3 taches")
        print("   - 2 conges")
